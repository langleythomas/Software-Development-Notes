...
- [1. Book Notes](#1-book-notes)
  ...
  - [1.2. `bash` Cookbook](#12-bash-cookbook)
    ...
    - [1.2.5. Executing Commands](#125-executing-commands)
      ...
      - [1.2.5.4. Telling Whether a Command Succeeded or Not](#1254-telling-whether-a-command-succeeded-or-not)
    ...
    - [1.2.9. Intermediate Shell Tools I](#129-intermediate-shell-tools-i)
      ...
      - [1.2.9.3. Getting a Simple True/False from a Search](#1293-getting-a-simple-truefalse-from-a-search)
    ...
    - [1.2.13. Working with Dates \& Times](#1213-working-with-dates--times)
      ...
      - [1.2.13.4. Converting Dates \& Times to Epoch Seconds](#12134-converting-dates--times-to-epoch-seconds)
    ...
    - [1.2.19. Housekeeping \& Administrative Tasks](#1219-housekeeping--administrative-tasks)
      ...
      - [1.2.19.4. Recovering Disconnected Sessions Using `screen`](#12194-recovering-disconnected-sessions-using-screen)
  ...
  - [1.3. The Pragmatic Programmer](#13-the-pragmatic-programmer)
    - [1.3.1. Preface to the Second Edition](#131-preface-to-the-second-edition)
      ...
      - [1.3.1.2. What's In a Name?](#1312-whats-in-a-name)
    ...
    - [1.3.4. A Pragmatic Approach](#134-a-pragmatic-approach)
      - [1.3.4.1. The Essence of Good Design](#1341-the-essence-of-good-design)
        ...
        - [1.3.4.1.3. Challenges (The Essence of Good Design)](#13413-challenges-the-essence-of-good-design)
    ...
    - [1.3.8. Concurrency](#138-concurrency)
      ...
      - [1.3.8.3. Actors \& Processes](#1383-actors--processes)
  ...
  - [2.1. `yt-dlp`](#21-yt-dlp)
    ...
    - [2.1.2. Download from YouTube](#212-download-from-youtube)
      ...
      - [2.1.2.2. Channels](#2122-channels)
        ...
        - [2.1.2.2.11. Rooster Teeth Podcasts](#212211-rooster-teeth-podcasts)
...
#### 1.2.1.1. Who Should Read This Book
...
##### 1.2.1.2.2. A Note About Code Examples
...
#### 1.2.2.4. Finding & Running Commands
...
#### 1.2.2.5. Getting Information About Files
...
#### 1.2.2.7. Determining if You Are Running Interactively
...
#### 1.2.3.1. Writing Output to the Terminal/Window
...
#### 1.2.3.2. Writing Output but Preserving Space
...
#### 1.2.3.3. Writing Output with More Formatting Control
...
#### 1.2.3.5. Appending Rather than Clobbering Output
...
#### 1.2.3.6. Using Just the Beginning of End of a File
...
#### 1.2.3.8. Saving or Grouping Output from Several Commands
...
#### 1.2.3.9. Connecting Two Programs by Using Output as Input
...
#### 1.2.3.10. Saving a Copy of Output Even While Using It as Input
...
#### 1.2.3.11. Keeping Files Safe from Accidental Overwriting
...
#### 1.2.3.12. Clobbering a File on Purpose
...
#### 1.2.4.1. Getting Input from File
...
#### 1.2.4.2. Keeping Your Data with Your Script
...
#### 1.2.4.3. Preventing Weird Behaviour in a Here-Document
...
#### 1.2.4.4. Indenting Here-Documents
...
#### 1.2.4.6. Getting a Yes or No Input
...
#### 1.2.4.7. Selecting from a List of Options
...
#### 1.2.4.8. Prompting for a Password
...
#### 1.2.5.1. Running Any Executable
...
#### 1.2.5.2. Running Several Commands in Sequence
...
#### 1.2.5.3. Running Several Commands All at Once
...
#### 1.2.5.4. Telling Whether a Command Succeeded or Not
...
#### 1.2.5.5. Running a Command Only if Another Command Succeeded
...
#### 1.2.5.6. Using Fewer `if` Statements
...
#### 1.2.5.7. Running Long Jobs Unattended
...
- When you put a job in the background (via the &, as described in
  [1.2.5.3. Running Several Command All at Once](#1253-running-several-commands-all-at-once)), it is still a child
...
#### 1.2.5.8. Displaying Error Messages When Failures Occur
...
- Similar to how the `&&` in [1.2.5.6. Using Fewer `if` Statements](#1256-using-fewer-if-statements) tells `bash` not
...
#### 1.2.5.9. Running Commands from a Variable
...
#### 1.2.5.10. Running All Scripts in a Directory
...
### 1.2.6. Basic Scripting: Shell Variables
...
#### 1.2.6.1. Embedding Documentation in Shell Scripts
...
#### 1.2.6.2. Promoting Script Readability
...
- Follow these best practices when you would like to make your script as readable as possible for the ease of
  ...
  - Document your script as noted in [1.2.6.1. Embedding Documentation in Shell Scripts](
    #1261-embedding-documentation-in-shell-scripts). Document your intent, not the trivial details of the code. If you
...
#### 1.2.6.3. Separating Variable Names from Surrounding Text
...
#### 1.2.6.5. Seeing All Variable Values
...
#### 1.2.6.6. Using Parameters in a Shell Script
...
#### 1.2.6.7. Looping Over Arguments Passed to a Script
...
#### 1.2.6.8. Handling Parameters with Spaces
...
#### 1.2.6.9. Handling Lists of Parameters with Spaces
...
#### 1.2.6.12. Getting Default Values
...
#### 1.2.6.13. Setting Default Values
...
#### 1.2.6.14. Using `null` as Valid Default Value
...
#### 1.2.6.15. Using More than Just a Constant String for Default
...
#### 1.2.6.16. Giving an Error Message for Unset Parameters
...
#### 1.2.6.17. Changing Pieces of a String
...
#### 1.2.6.18. Getting the Absolute Value of a Number
...
#### 1.2.6.19. Using `bash` for `basename`
...
#### 1.2.6.20. Using `bash` for `dirname`
...
#### 1.2.6.21. Using Alternate Values for Comma-Separated Values
...
#### 1.2.6.22. Using Array Variables
...
#### 1.2.6.23. Converting Between Upper- and Lower-case
...
#### 1.2.6.24. Converting to Camel Case
...
#### 1.2.7.1. Doing Arithmetic in Your Shell Script
...
#### 1.2.7.2. Branching on Conditions
...
#### 1.2.7.4. Testing for More than One Thing
...
#### 1.2.7.5. Testing for String Characteristics
...
### 1.2.8. Testing with Pattern Matches
...
#### 1.2.8.5. Looping with Floating-Point Values
...
#### 1.2.8.7. Parsing Command-Line Arguments
...
#### 1.2.8.9. Changing the Prompt on Simple Menus
...
### 1.2.9. Intermediate Shell Tools I
...
- Use the `quiet` option for `grep` when you want to know whether a certain string is in a particular file, and you
  ...
  or `no`. [5.7.2. O'Reilly: `bash` Cookbook, 2nd Edition](#572-oreilly-bash-cookbook-2nd-edition)
...
#### 1.2.9.4. Doing a Search in a Pipeline
...
#### 1.2.9.5. Grepping Compressed Files
...
#### 1.2.9.6. Keeping Some Output, Discarding the Rest
...
#### 1.2.9.7. Keeping Only a Portion of a Line of Output
...
#### 1.2.9.8. Reversing the Words on Each Line
...
#### 1.2.9.9. Summing a List of Numbers
...
#### 1.2.9.10. Counting String Values with `awk`
...
#### 1.2.9.11. Counting String Values with `bash`
...
#### 1.2.9.12. Showing Data as a Quick and Easy Histogram
...
#### 1.2.9.13. An Easy Histogram with `bash`
...
#### 1.2.9.14. Showing a Paragraph of Text After a Found Phrase
...
### 1.2.10. Intermediate Shell Tools II
...
#### 1.2.10.4. Cutting Out Parts of Your Output
...
#### 1.2.10.5. Removing Duplicate Lines
...
#### 1.2.10.8. Checking a `tar` Archive for Unique Directories
...
#### 1.2.10.10. Converting Upper-case to Lower-case
...
#### 1.2.10.12. Removing Smart Quotes
...
#### 1.2.10.15. Doing More with `less`
...
### 1.2.11. Finding Files: `find`, `locate`, `slocate`
...
#### 1.2.11.1. Finding All Your MP3 Files
...
#### 1.2.11.2. Handling Filenames Containing Odd Characters
...
- Rewriting the example from [1.2.11.1. Finding All Your MP3 Files](#12111-finding-all-your-mp3-files).
  [5.7.2. O'Reilly: `bash` Cookbook, 2nd Edition](#572-oreilly-bash-cookbook-2nd-edition)
...
#### 1.2.11.3. Finding Files Across Symbolic Links
...
#### 1.2.11.4. Finding Files Irrespective of Case
...
#### 1.2.11.5. Finding Files by Date
...
#### 1.2.11.6. Finding Files by Type
...
#### 1.2.11.8. Finding Files by Content
...
#### 1.2.11.9. Finding Existing Files & Content Fast
...
### 1.2.12. Additional Features for Scripting
...
#### 1.2.12.1. "Daemon-ising" Your Script
...
#### 1.2.12.2. Reusing Code with Includes & Sourcing
...
#### 1.2.12.3. Using Configuration Files in a Script
...
#### 1.2.12.5. Using Functions: Parameters & Return Values
...
#### 1.2.12.7. Redefining Commands with `alias`
...
#### 1.2.12.8. Avoiding Aliases & Functions
...
### 1.2.13. Working with Dates & Times
...
#### 1.2.13.1. Formatting Dates for Display
...
#### 1.2.13.5. Converting Epoch Seconds to Dates & Times
...
#### 1.2.18.5. Changing Your `$PATH` Temporarily
...
#### 1.2.18.15. Creating a Better `cd` Command
...
#### 1.2.18.17. Getting to the Bottom of Things
...
#### 1.2.19.14. Editing a File in Place
...
#### 1.2.19.16. Finding Lines That Appear in One File but Not in Another
...
#### 1.2.19.18. Writing to a Circular Log
...
#### 1.2.19.20. Grepping `ps` Output Without Also Getting the `grep` Process Itself
...
#### 1.2.19.22. Adding a Prefix or Suffix to Output
...
#### 1.2.19.26. Commodifying Numbers
...
#### 1.2.20.1. Moving Quickly Among Arbitrary Directories
...
#### 1.2.20.5. Finishing Names for You
...
#### 1.2.20.7. Big Changes, More Lines
...
#### 1.2.21.1. Forgetting to Set Execute Permissions
...
#### 1.2.21.3. Forgetting That the Current Directory Is Not in the `$PATH`
...
#### 1.2.21.5. Expecting to Change Exported Variables
...
#### 1.2.21.7. Forgetting that Pattern Matching Alphabetises
...
#### 1.2.21.9. Making Your Terminal Sane Again
...
#### 1.2.21.11. Seeing Odd Behaviour from `printf`
...
## 1.3. The Pragmatic Programmer

<details open>

<summary>Click to expand/minimise the full contents of this book.</summary>

### 1.3.1. Preface to the Second Edition

#### 1.3.1.1. How the Book is Organised
...
- There is a list of tips throughout the book, often emphasising points in the accompanying text. The following is the
  ...
  - [Tip 1: Care About Your Craft](#13221-tip-1-care-about-your-craft)

  - [Tip 2: Think! About Your Work](#13222-tip-2-think-about-your-work)

  - [Tip 3: You Have Agency](#13311-tip-3-you-have-agency)

  - [Tip 4: Provide Options, Don't Make Lame Excuses](#13323-tip-4-provide-options-dont-make-lame-excuses)

  - [Tip 5: Don't Live with Broken Windows](#13331-tip-5-dont-live-with-broken-windows)

  - [Tip 5: Don't Live with Broken Windows](#13331-tip-5-dont-live-with-broken-windows)

  - [Tip 7: Remember the Big Picture](#13351-tip-7-remember-the-big-picture)

  - [Tip 8: Make Quality a Requirements Issue](#13362-tip-8-make-quality-a-requirements-issue)

  - [Tip 9: Invest Regularly in Your Knowledge Portfolio](#13372-tip-9-invest-regularly-in-your-knowledge-portfolio)

  - [Tip 10: Critically Analyse What You Read \& Hear](#13375-tip-10-critically-analyse-what-you-read--hear)

  - [Tip 11: English is Just Another Language](#13381-tip-11-english-is-just-another-language)

  - [Tip 12: It's Both What You Say and the Way You Say It](
      #133810-tip-12-its-both-what-you-say-and-the-way-you-say-it)

  - [Tip 13: Build Documentation In, Don't Bolt It On](#133812-tip-13-build-documentation-in-dont-bolt-it-on)

  - [Tip 14: Good Design is Easier to Change Than Bad Design](
      #13411-tip-14-good-design-is-easier-to-change-than-bad-design)

  - [Tip 15: DRY - Don't Repeat Yourself](#13421-tip-15-dry---dont-repeat-yourself)

  - [Tip 16: Make It Easy to Rescue](#13427-tip-16-make-it-easy-to-rescue)

  - [Tip 17: Eliminate Effects Between Things](#13433-tip-17-eliminate-effects-between-things)

  - [Tip 18: There Are No Final Decisions](#13441-tip-18-there-are-no-final-decisions)

  - [Tip 19: Forego Following Fads](#13442-tip-19-forego-following-fads)
...
### 1.3.2. From the Preface to the First Edition
...
#### 1.3.2.1. Who Should Read This Book?
...
#### 1.3.2.2. What Makes a Pragmatic Programmer?
...
#### 1.3.2.3. Individual Pragmatists, Large Teams
...
#### 1.3.2.4. It's a Continuous Process

- Every day, work to refine the skills you have and to add new tools to your repertoire.
  [5.10.1. The Pragmatic Bookshelf: The Pragmatic Programmer, 20th Anniversary Edition](
    #5101-the-pragmatic-bookshelf-the-pragmatic-programmer-20th-anniversary-edition)

### 1.3.3. A Pragmatic Philosophy

#### 1.3.3.1. It's Your Life
...
##### 1.3.3.1.1. Tip 3: You Have Agency
...
#### 1.3.3.2. The Cat Ate My Source Code
...
##### 1.3.3.2.3. Tip 4: Provide Options, Don't Make Lame Excuses
...
##### 1.3.3.2.4. Challenges (Take Responsibility)
...
##### 1.3.3.3.1. Tip 5: Don't Live with Broken Windows
...
##### 1.3.3.3.3. Challenges (Software Entropy)
...
#### 1.3.3.4. Stone Soup & Boiled Frogs
...
##### 1.3.3.4.1. Tip 6 Be a Catalyst for Change

- You can't force change on people. Instead, show them how the future might be and help them participate in creating it.
  [5.10.1. The Pragmatic Bookshelf: The Pragmatic Programmer, 20th Anniversary Edition](
    #5101-the-pragmatic-bookshelf-the-pragmatic-programmer-20th-anniversary-edition)

#### 1.3.3.5. The Villager's Side
...
##### 1.3.3.5.1. Tip 7: Remember the Big Picture
...
##### 1.3.3.5.2. Challenges (The Villager's Side)

- By progressively deceiving your organisation (as outlined in the
  [1.3.3.4. Stone Soup & Boiled Frogs](#1334-stone-soup--boiled-frogs) section), you're doing it harm. Can you determine
...
##### 1.3.3.6.1. Involve Your Users in the Trade Off
...
##### 1.3.3.6.2. Tip 8: Make Quality a Requirements Issue
...
##### 1.3.3.6.4. Challenges (Good Enough Software)
...
#### 1.3.3.7. Your Knowledge Portfolio
...
##### 1.3.3.7.1. Building Your Portfolio
...
##### 1.3.3.7.2. Tip 9: Invest Regularly in Your Knowledge Portfolio
...
##### 1.3.3.7.3. Opportunities for Learning
...
##### 1.3.3.7.5. Tip 10: Critically Analyse What You Read & Hear
...
##### 1.3.3.7.6. Challenges (Your Knowledge Portfolio)
...
##### 1.3.3.8.1. Tip 11: English is Just Another Language
...
##### 1.3.3.8.3. Know What You Want to Say
...
##### 1.3.3.8.7. Involve Your Audience
...
##### 1.3.3.8.10. Tip 12: It's Both What You Say and the Way You Say It
...
##### 1.3.3.8.11. Communication Through Documentation
...
##### 1.3.3.8.12. Tip 13: Build Documentation In, Don't Bolt It On
...
##### 1.3.3.8.13. Challenges (Communicate)
...
#### 1.3.4.1. The Essence of Good Design
...
##### 1.3.4.1.1. Tip 14: Good Design is Easier to Change Than Bad Design
...
##### 1.3.4.1.2. ETC is a Value, Not a Rule
...
##### 1.3.4.1.3. Challenges (The Essence of Good Design)
...
#### 1.3.4.2. DRY - The Evils of Duplication
...
##### 1.3.4.2.1. Tip 15: DRY - Don't Repeat Yourself
...
##### 1.3.4.2.2. DRY is More Than Code
...
###### 1.3.4.2.3.1. Not All Code Duplication is Knowledge Duplication
...
##### 1.3.4.2.4. Duplication in Documentation
...
###### 1.3.4.2.4.1. DRY Violations in Data
...
##### 1.3.4.2.5. Representational Duplication
...
###### 1.3.4.2.5.1. Duplication Across Internal APIs
...
###### 1.3.4.2.5.2. Duplication Across External APIs
...
###### 1.3.4.2.5.3. Duplication within Data Sources
...
##### 1.3.4.2.6. Interdeveloper Duplication
...
##### 1.3.4.2.7. Tip 16: Make It Easy to Rescue
...
##### 1.3.4.3.1. What is Orthogonality?
...
##### 1.3.4.3.2. Benefits of Orthogonality
...
##### 1.3.4.3.3. Tip 17: Eliminate Effects Between Things
...
##### 1.3.4.3.8. Orthogonality Through Documentation
...
##### 1.3.4.3.9. Living with Orthogonality
...
###### 1.3.4.3.9.1. Challenges (Living with Orthogonality)
...
###### 1.3.4.3.9.2. Exercises (Living with Orthogonality)

###### 1.3.4.3.9.3. Exercise 1
...
##### 1.3.4.4.1. Tip 18: There Are No Final Decisions
...
##### 1.3.4.4.2. Tip 19: Forego Following Fads
...
##### 1.3.4.4.3. Challenges (Reversibility)
...
#### 1.3.6.2. Dead Programs Tell No Tales
...
#### 1.3.6.4. How to Balance Resources
...
#### 1.3.7.2. Juggling the Real World
...
#### 1.3.8.2. Shared State is Incorrect State
...
#### 1.3.9.1. Listen to Your Lizard Brain
...
#### 1.3.10.2. Solving Impossible Puzzles
...
#### 1.3.10.4. The Essence of Agility
...
#### 1.3.11.3. Pragmatic Starter Kit
...
#### 2.1.1.3. Verify `yt-dlp` Installation
...
##### 2.1.2.1.1. Funhaus (Playlists)

##### 2.1.2.1.2. Funhaus Members Playlist
...
##### 2.1.2.1.3. Funhaus Live Playlist
...
##### 2.1.2.2.5. Inside Gaming (Formerly "The Know")
...
##### 2.1.2.2.9. Overly Sarcastic Productions
...
##### 2.1.2.2.11. Rooster Teeth Podcasts
...
##### 3.1.1.1.1. What is Database Sharding?
...
- **Sharding**
  ...
  - A form of horizontal scaling, as additional nodes are included to share the database load. In contract, vertical
    ...
    storage. [5.4.1. Mongodb: Database Sharding](#541-mongodb-database-sharding)

<details open>

<summary>Click to expand/minimise the additional details on database sharding.</summary>

##### 3.1.1.1.2. Do You Need Database Sharding?
...
##### 3.1.1.1.3. Advantages of Sharding
...
##### 3.1.1.1.4. Disadvantages of Sharding
...
##### 3.1.1.1.5. How Does Sharding Work? These Questions Should Be Answered
...
- **How Will the Data Be Distributed Across Shards?**
  ...
  - The fundamental question behind any sharded database. The choice will have impacts on both performance and
    maintenance. See [3.1.1.1.6. Sharding Architectures and Types](#31116-sharding-architectures-and-types) for more
    details.
    [5.4.1. Mongodb: Database Sharding](#541-mongodb-database-sharding)
...
##### 3.1.1.1.6. Sharding Architectures and Types

###### 3.1.1.1.6.1. Ranged/Dynamic Sharding

- Takes a field on the record as an input, and allocated that record to the appropriate shard, based on a predefined
  range. [5.4.1. Mongodb: Database Sharding](#541-mongodb-database-sharding)
...
###### 3.1.1.1.6.2. Algorithmic/Hashed Sharding
...
- Like [3.1.1.1.6.1. Ranged/Dynamic Sharding](#311161-rangeddynamic-sharding) a set of fields determines the allocation
...
- [3.1.1.1.6.1. Ranged/Dynamic Sharding](#311161-rangeddynamic-sharding) reflects the natural structure of the data
...
###### 3.1.1.1.6.3. Entity-Based/Relationship-Based Sharding
...
###### 3.1.1.1.6.4. Geography-Based Sharding/Geosharding

- Like [3.1.1.1.6.3. Entity-Based/Relationship-Based Sharding](#311163-entity-basedrelationship-based-sharding),
  related data is kept together in a single shard. The data is related by geography. This is like
  [3.1.1.1.6.1. Ranged/Dynamic Sharding](#311161-rangeddynamic-sharding) where the shard key contains geographic
  information.
  [5.4.1. Mongodb: Database Sharding](#541-mongodb-database-sharding)
...
##### 3.1.1.1.7. Sharding vs Partitioning
...
#### 3.2.1.1. Service Mesh

##### 3.2.1.1.1. Service Mesh Overview
...
- It provides the following component services and functions:
  ...
  - **Container Orchestration Framework**
    ...
    - Kubernetes is the most common example. [5.5.1. Nginx: What Is A Service Mesh?](#551-nginx-what-is-a-service-mesh)
...
##### 3.2.1.1.2. Scenarios for a service mesh
...
##### 3.2.1.1.3. Selection Criteria for Installing a Service Mesh
...
#### 3.3.1.1. What is Network Slicing?

- An operators' best answer on how to build and manage a network, that meets and exceeds the emerging requirements from
  a wide range of users.
  [5.1.1. Ericsson: Navigate the Network Slicing Transformation Journey](
    #511-ericsson-navigate-the-network-slicing-transformation-journey)
...
#### 3.3.1.2. Benefits of Network Slicing
...
### 5.7.1. O'Reilly: 97 Things Every Programmer Should Know
